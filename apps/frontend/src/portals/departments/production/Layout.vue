    ...
    <main class="flex-1 overflow-auto flex flex-col">
      <header class="h-16 bg-white border-b flex items-center justify-between px-8 shrink-0">
        <div class="flex items-center space-x-4">
          <span class="text-sm font-medium text-text-main/60 capitalize">Portals / production</span>
        </div>
        <div class="flex items-center space-x-4">
...
const navPages = [
  { name: 'production-dashboard', path: '/production', title: 'Dashboard' },
  { name: 'production-orderqueue', path: '/production/orderqueue', title: 'OrderQueue' },
  { name: 'production-washingstation', path: '/production/washingstation', title: 'WashingStation' },
  { name: 'production-dryingstation', path: '/production/dryingstation', title: 'DryingStation' },
];
</script>
