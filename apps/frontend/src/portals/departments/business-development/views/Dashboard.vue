<template>
  <div class="p-8">
    <div class="flex items-center justify-between mb-8">
      <div>
        <h1 class="text-3xl font-bold text-primary font-heading">Dashboard</h1>
        <p class="text-text-main/70 mt-2">Manage business development dashboard and operations.</p>
      </div>
