<template>
  <div class="p-8">
    <div class="flex items-center justify-between mb-8">
      <div>
        <h1 class="text-3xl font-bold text-primary font-heading">Complaint Manager</h1>
        <p class="text-text-main/70 mt-2">Manage customer service complaint manager and operations.</p>
      </div>
    ...
    <div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
      ...
      <div class="p-12 text-center text-text-main/40 italic">
        No data available for Complaint Manager yet.
      </div>
    </div>
  </div>
</template>
